    ...
    for fold in fold_list:
        for grade in grade_list:
            ...
            select('/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/proto/mask/CRC/'+label,'/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/proto/coordinate/CRC/'+label,
                   # '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/raw/CRC/'+label,'/data/hdd1/syh/PycharmProjects/CGC-Net/data_final_add/raw/CRC/' + label)
                    '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/proto/mask/CRC/'+label,'/data/hdd1/syh/PycharmProjects/CGC-Net/data_final_add/proto/mask/CRC/' + label)