...
class DataSetting:
    def __init__(self, label = 'fold_2/2_low_grade'):
        self.dataset = 'CRC'
        self.label  = label
        self.root = '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/raw'#'/research/dept6/ynzhou/gcnn/data/raw'
        self.test_data_path = os.path.join(self.root, self.dataset, self.label)
        self.save_path = '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/proto'#'/research/dept6/ynzhou/gcnn/data/proto'
        self.do_eval = False
        ...
        self.des_path_mask = '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/all_dark'
        self.des_path_mask_png = '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/all_dark_png'
        self.des_path_raw = '/data/hdd1/syh/PycharmProjects/CGC-Net/data_final/all_raw'
...
def _get_batch_features_new(numpy_queue, info_queue):
    ...
    while True:
        ...
        if name != 'end':
            ...
            des_mask_path = os.path.join(self.des_path_mask, self.dataset, self.label, name)
            des_mask_path_png = os.path.join(self.des_path_mask_png, self.dataset, self.label, name.replace('.npy', '.png'))
            des_raw_path = os.path.join(self.des_path_raw, self.dataset, self.label, name.replace('.npy', '.png'))
